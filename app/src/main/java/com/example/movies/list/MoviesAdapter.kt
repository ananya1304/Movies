...
class MoviesAdapter(private val movieListFragment: ListFragment, private var movieList: List<Movie>) :
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener { movieListFragment.onMovieItemClick(position) }
